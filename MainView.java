...
public class MainView {
    ...
    public void show() {
        if (mainMenuDialog == null || !mainMenuDialog.isVisible()) {
            showMainMenu();
        }
    }
    ...
    private void showMainMenu() {
        ...
        manageProductsButton.addActionListener(e -> {
            mainMenuDialog.dispose(); // Add this line
        ...
        mainMenuDialog = new JDialog(); // Change this line
        mainMenuDialog.setTitle("Main Menu");
        mainMenuDialog.setContentPane(mainPanel);
        mainMenuDialog.pack();
    ...
    public void onPurchaseButtonClick(Customer customer, JTable selectedProductsTable,
        ...
        int customerIndex = controller.getCustomers().indexOf(customer);
        controller.updateCustomer(customerIndex, customer);
        customerTableModel.updateCustomer(customerIndex, customer);
        saveCustomersToFile();
    ...
    private void showPurchaseDialog(Customer customer, CustomerTableModel customerTableModel) {
        ...
        purchaseButton.addActionListener(e -> {
            onPurchaseButtonClick(customer, selectedProductsTable, customerTableModel); // Update this line
        });
